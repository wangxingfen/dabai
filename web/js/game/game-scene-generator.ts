...
export class GameSceneGenerator {
  declare App: any;
  declare THREE: any;
  declare generatedObjects: any[];
  declare sceneLighting: any; // 保存原始光照引用，退出时恢复
  declare _savedAmbientIntensity: number | null;
   ...
   */
  generateEnvironment(config: any = {}) {
   ...
   * @param {any} options
   */
  generateTreasure(position, options: any = {}) {
    const THREE = this.THREE;
   ...
   * @param {any} options
   */
  generateCollectible(position, options: any = {}) {
    const THREE = this.THREE;
