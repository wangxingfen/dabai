...
export class MobaGame extends BaseGame {
    ...
    for (const team of ['blue', 'red']) {
      for (let i = 0; i < 5; i++) {
        ...
        const hero = {
          ...
          chestMesh: null, visorMesh: null, haloMesh: null, headMat: null,
          isPlayer: false,
  ...
  _spawnMinion(team, lane, type, x, z, wave = 0) {
    ...
    const minion = {
      ...
      moveTarget: null,
      mesh: null, healthBar: null, bodyMesh: null, mat: null,
    };
    const group = new THREE.Group();
  ...
  declare App: any;
  declare THREE: any;
  declare _botDecisionTimer: any;
  declare _disposeObject: any;
  declare _gameTime: any;
  declare _getPlayerFacing: any;
  declare _getPlayerPosition: any;
  declare _getRecentEvents: any;
  declare _groundY: any;
  declare _healthBarSprites: any;
  declare _lastDt: any;
  declare _lastEventIndex: any;
  declare _lastMoveSpeed: any;
  declare _llmAccumReward: any;
  declare _llmPolicyEnabled: any;
  declare _llmPolicyInterval: any;
  declare _llmPolicyTimer: any;
  declare _llmRewardBias: any;
  declare _llmStats: any;
  declare _llmStrategy: any;
  declare _llmWaitingResponse: any;
  declare _minimapCamPos: any;
  declare _minimapDragging: any;
  declare _minimapFocus: any;
  declare _minimapFocusTimer: any;
  declare _mobaUI: any;
  declare _nextMinionWave: any;
  declare _onMobaKey: any;
  declare _originalBackground: any;
  declare _originalFog: any;
  declare _pushEvent: any;
  declare _rl: any;
  declare _rlAutoRestart: any;
  declare _rlAutoRestartDelay: any;
  declare _rlDragCleanup: any;
  declare _rlEnabled: any;
  declare _rlEpisodeReward: any;
  declare _rlLastMainHp: any;
  declare _rlPrevMainHpSet: any;
  declare _rlShared: any;
  declare _rlSpeedIdx: any;
  declare _sharedGeometries: any;
  declare _sharedMaterials: any;
  declare _skillInputQueue: any;
  ...
  declare jungle: any;
  declare killFeed: any;
  declare minions: any;
  declare moveSpeed: any;
  declare name: any;
  declare onComplete: any;
  declare playerHeroId: any;
  declare projectiles: any;
  declare score: any;
  declare spectating: any;
  declare startTime: any;
  declare state: any;
  declare structures: any;
  declare teamGold: any;
  declare teamKills: any;
  declare uiHint: any;
}
