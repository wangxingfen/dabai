...
import { encodeObservation } from "./../rl/observation-spec.ts";
...
export class TreasureHuntGame extends BaseGame {
  ...
  declare App: any;
  declare THREE: any;
  declare _cellSize: any;
  declare _clueCount: any;
  declare _clues: any;
  declare _collectedCount: any;
  declare _collectibles: any;
  declare _currentQuiz: any;
  declare _groundY: any;
  declare _isGrounded: any;
  declare _lastMoveSpeed: any;
  declare _lightingUp: any;
  declare _litDuration: any;
  declare _litKind: any;
  declare _litObj: any;
  declare _litTime: any;
  declare _mazeCols: any;
  declare _mazeData: any;
  declare _mazeRows: any;
  declare _playerRadius: any;
  declare _playerVelocityY: any;
  declare _pushEvent: any;
  declare _questionsAnswered: any;
  declare _questionsCorrect: any;
  declare _quizOpen: any;
  declare _quizPending: any;
  declare _quizQuestions: any;
  declare _quizService: any;
  declare _quizUI: any;
  declare _rl: any;
  declare _rlActionSpec: any;
  declare _rlObsSpec: any;
  declare _starCount: any;
  declare _totalCollectibles: any;
  declare _treasure: any;
  declare _treasureLockNotified: any;
  declare _treasureOpen: any;
  declare _visitedClues: any;
  declare _wallBoxes: any;
  declare _walls: any;
