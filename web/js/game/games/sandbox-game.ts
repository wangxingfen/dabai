...
export class SandboxGame extends BaseGame {
  ...
  checkCollision(newX, newZ, options: { ignoreTerrain?: boolean } = {}) {
    const avatar = this.App.currentAvatar;
  ...
  _createResourceMesh(type, pos, info) {
    ...
    const getMat = (color, roughness = 0.7, opts: { metalness?: number; emissive?: number; emissiveIntensity?: number; flatShading?: boolean } = {}) => {
  ...
  declare _jumpsLeft: any;
  declare _lastJumpTime: any;
  declare _lastKnownGroundY: any;
  declare _lastMoveSpeed: any;
  declare _maxJumps: any;
  declare _originalBackground: any;
  declare _playerVelocityY: any;
  declare _pushEvent: any;
  declare _resourcesCollected: any;
  declare _rl: any;
  declare _rlActionSpec: any;
  declare _rlObsSpec: any;
  declare _sharedBlockGeo: any;
  declare _sharedMaterials: any;
  declare addToScene: any;
  declare animals: any;
  declare blockSize: any;
  declare chunkSize: any;
  declare chunks: any;
  declare currentBiome: any;
  declare currentChunk: any;
  ...
  declare name: any;
  declare renderDistanceChunks: any;
