...
export class HumanBaselineEvaluator {
   ...
   */
  async loadBaseline(url = 'humanBaseline.json') {
    try {
  ...
  /** 人类基线表 */
  get baselines() { return this._baselines; }
   ...
   */
  recordEpisode(gameKey, { durationMs = 0, win = false } = {}) {
   ...
   */
  report(gameKey, { windowSize = DEFAULT_WINDOW } = {}) {
