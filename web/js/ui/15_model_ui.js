export default (function init(App) {
  ...
  App.renderModelList = function renderModelList(models) {
    if (!App.modelListEl) return;
    App.modelListEl.innerHTML = '';
    const currentSaved = JSON.parse(localStorage.getItem('dabai.currentModel') || 'null');
  ...
  App.refreshModelListSelection = function refreshModelListSelection(activeName) {
  ...
  App.uploadModelFile = async function uploadModelFile(file) {
