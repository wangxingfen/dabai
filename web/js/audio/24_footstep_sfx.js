...
// ============================================================
export default function init_24_footstep_sfx(App) {
  ...
  // ---------- 全局静音开关 ----------
  App.setFootstepMuted = function setFootstepMuted(muted) {
    App.footstepMuted = !!muted;
  };

  // ---------- 播放一步 ----------
  App.playFootstep = function playFootstep(vol) {
  ...
  App.updateFootstepSFX = function updateFootstepSFX(phase, speedFactor) {
    if (!App._footstepSFXReady) return;
